...
//     let data = fs::read_to_string("output/mappings/grid_mappings.json").expect("Unable to read file");
...
//             let output_json_file = File::create(output_json_path).expect("Unable to create output file");
